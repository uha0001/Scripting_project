...
##### Note: The main purpose of this project is to utilize the comp. Biol. skills we learned from Dr. Santos. At least one take home message would be to learn how to install and run typical large bioinformatics tools in Alabama Supercomputer Cencer (ASC). If you've attempted it before, you'd know its not trivial.
